...
import pt.uc.dei.aor.projeto6.grupod.exceptions.MusicInPlaylistException;
import pt.uc.dei.aor.projeto6.grupod.exceptions.PlaylistNameException;
...
public class PlaylistFacade extends AbstractFacade<Playlist> {
    ...
    @Inject MusicFacade musicFacade;
     ...
     * @param p
     * @return the playlist
     * @throws pt.uc.dei.aor.projeto3.grupod.exceptions.PlaylistNameException 
     */
    public Playlist newPlaylist(Playlist p) throws PlaylistNameException {
     ...
     * @throws PlaylistNameException 
     */
    public void createPlaylist(Playlist p) throws PlaylistNameException {
    ...
    /**
     * Copy a lisy of music to a playlist
     * @param p
     * @param m 
     */
    
    public void copyListToPlaylist(Playlist p, Music m){
