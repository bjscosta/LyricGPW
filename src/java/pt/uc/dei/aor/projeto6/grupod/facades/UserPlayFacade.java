...
import pt.uc.dei.aor.projeto6.grupod.exceptions.DuplicateEmailException;
import pt.uc.dei.aor.projeto6.grupod.exceptions.PassDontMatchException;
import pt.uc.dei.aor.projeto6.grupod.exceptions.PasswordNotCorrectException;
import pt.uc.dei.aor.projeto6.grupod.exceptions.UserNotFoundException;
import pt.uc.dei.aor.projeto6.grupod.utilities.EncriptMD5;
...
public class UserPlayFacade extends AbstractFacade<UserPlay> {
     ...
     * @throws
     * pt.uc.dei.aor.projeto3.grupod.exceptions.PasswordNotCorrectException
     */
    ...
    public static String getMusicFolder(UserPlay u) {
        ...
        f.mkdir();
        return f.getAbsolutePath() +"/"+ u.geteMail() + "/";
    }
