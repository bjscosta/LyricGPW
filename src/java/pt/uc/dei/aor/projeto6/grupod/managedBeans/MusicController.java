...
import pt.uc.dei.aor.projeto6.grupod.ejb.MusicEJB;
...
import pt.uc.dei.aor.projeto6.grupod.exceptions.NotMp3Exception;
import pt.uc.dei.aor.projeto6.grupod.exceptions.ReleaseYearInvalidException;
...
public class MusicController {
    ...
    public void init() {
        ...
        pathServlet = "http://" + ext.getRequestServerName() + ":" + ext.getRequestServerPort()
                + ext.getApplicationContextPath() + "/faces/popularServlet"
                + "?top=todas&" + getRandomNumber();
    ...
    public String getPathServlet() {
        return pathServlet;
    }

    public void setPathServlet(String pathServlet) {
